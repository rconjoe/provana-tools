...
module.exports = {
  ...
  anonCreateSupporter: async () => {
    ...
    .then((answer) => {
      newSupporter.email = answer.email;
    })
    ...
    .then((answer) => {
      newSupporter.username = answer.username
    })
    ...
    .then((answer) => {
      newSupporter.timezone = answer.timezone
    })
    ...
    .then((answer) => {
      newSupporter.avatar = answer.avatar
    })
    ...
    .then((answer) => {
      newSupporter.banner = answer.banner
    })
